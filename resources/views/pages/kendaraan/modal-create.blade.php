                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="tahun_pembuatan"
                                ...
                                value="{{ old('tahun_pembuatan') }}" min="1901" max="{{ date('Y') }}"
                                step="1" placeholder="Contoh: 2020">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="stnk_kadaluarsa"
                                class="form-control @error('stnk_kadaluarsa') is-invalid @enderror"
                                value="{{ old('stnk_kadaluarsa') }}" min="{{ date('Y') }}" step="1"
                                placeholder="Contoh: 2020">
                            @error('stnk_kadaluarsa')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    </div>
