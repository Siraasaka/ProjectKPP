                            ...
                            <td class="teks-center">
                                <div class="d-flex justify-content-center gap-1">
                                    <button class="btn btn-sm btn-warning mr-1" data-toggle="modal" data-target="#editModal"
                                        ...
                                        data-jenis="{{ $item->jenis_kendaraan }}"
                                        data-merek="{{ $item->merek_kendaraan }}" data-nopol="{{ $item->nomor_polisi }}"
                                        data-rangka="{{ $item->nomor_rangka }}" data-mesin="{{ $item->nomor_mesin }}"
                                        data-pembuatan="{{ $item->tahun_pembuatan }}"
                                        data-pemilik="{{ $item->nama_pemilik }}"
                                        data-pajak="{{ $item->pajak_jatuh_tempo }}"
