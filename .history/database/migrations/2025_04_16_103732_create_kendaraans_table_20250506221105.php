    ...
    return new class extends Migration
    {
        ...
        public function up(): void
        {
            Schema::create('kendaraans', function (Blueprint $table) {
                ...
                $table->date('pajak'); // Ganti dari pajak_jatuh_tempo
                $table->date('stnk');  // Tambahkan kolom ini
                $table->enum('status_kendaraan', ['tersedia', 'terpakai', 'service'])->default('tersedia');
                $table->softDeletes();
                $table->timestamps();
            });
        }
