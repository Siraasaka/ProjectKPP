...
class KendaraanController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'stnk_kadaluarsa' => ['required', 'integer', 'digits:4', 'min:1900', 'max:' . date('Y')],
        ], [
            ...
            'stnk_kadaluarsa.min' => 'Tahun STNK minimal 1900.',
            'stnk_kadaluarsa.max' => 'Tahun STNK tidak boleh lebih dari tahun sekarang.',
