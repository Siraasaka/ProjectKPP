...
class PeminjamanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $kendaraan->update(['status_kendaraan' => 'terpakai']);
    ...
    public function selesaikan($id)
    {
        ...
        // optional: balikin status kendaraan ke "tersedia"
        Kendaraan::where('id', $peminjaman->kendaraan_id)
            ->update(['status_kendaraan' => 'tersedia']);

        return back()->with('success', 'Status peminjaman berhasil diselesaikan.');
    }
}
