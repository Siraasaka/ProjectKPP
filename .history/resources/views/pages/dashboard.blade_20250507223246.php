    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="ms-auto position-relative">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-bs-toggle="dropdown"
                ...
                <span class="badge rounded-pill bg-danger position-absolute top-0 end-0">3+</span>
            </a>
            ...
            <div class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    ...
                    <div>
                        <div class="small text-muted">December 12, 2019</div>
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    ...
                    <div>
                        <div class="small text-muted">December 7, 2019</div>
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    ...
                    <div>
                        <div class="small text-muted">December 2, 2019</div>
