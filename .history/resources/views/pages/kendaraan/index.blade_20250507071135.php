                ...
                <tbody>
                    @foreach ($kendaraans as $item)
                        <tr>
                            ...
                            <td>{{ $item->nup }}</td>
                            <td>
                                @if ($item->status_kendaraan == 'roda_empat')
                            ...
                            <td class="btn-aksi">
                                <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#editModal"
                                    data-id="{{ $kend->id }}" data-nup="{{ $kend->nup }}"
                                    data-jenis="{{ $kend->jenis_kendaraan }}" data-merek="{{ $kend->merek_kendaraan }}"
                                    data-polisi="{{ $kend->nomor_polisi }}" data-tahun="{{ $kend->tahun_pembuatan }}"
                                    data-pajak="{{ $kend->pajak_jatuh_tempo }}"
                                    data-stnk="{{ $kend->stnk_kadaluarsa }}">Edit</button>
