                    ...
                    @foreach ($kendaraans as $item)
                        <tr>
                            ...
                            <td class="btn-aksi">
                                ...
                                {{-- <button class="btn btn-sm btn-warning" data-toggle="modal" data-target="#servisModal"
                                    data-id="{{ $item->id }}">
                                    Servis
                                </button> --}}
                            </td>
...
@section('scripts')
    <script>
        ...
        $('#editModal').on('show.bs.modal', function(e) {
            ...
            modal.find('input[name=nomor_polisi]').val(btn.data('polisi'));
            modal.find('input[name=tahun_pembuatan]').val(btn.data('tahun'));
